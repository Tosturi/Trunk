...
class TestAPI:
    ...
    @allure.story('Test POST')
    @allure.tag('POST')
    @allure.severity(allure.severity_level.CRITICAL)
    def test_post(self, create_user_data):
    ...
    @allure.story('Test PUT')
    @allure.tag('PUT')
    @allure.severity(allure.severity_level.CRITICAL)
    def test_put(self, create_user_data):
        user_data = create_user_data
    ...
    @allure.story('Test PATCH')
    @allure.tag('PATCH')
    @allure.severity(allure.severity_level.NORMAL)
    def test_patch(self, create_user_data):
        user_data = create_user_data
